...
if __name__ == "__main__":
    # Get identities of CASIA dataset
    identities = glob(os.path.join(CASIA_DIR, "*"))
    ...
    # Edited to reduce number of sample sets to N_IMAGES. For simplicity and testing
    for identity in identities:
        files = glob(os.path.join(CASIA_DIR, identity, "*", "*.*"))
        shuffle(files)
